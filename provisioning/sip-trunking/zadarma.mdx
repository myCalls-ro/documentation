...
4. Click on external services and then check the option for SIP URI.
  ...
  Add ```sip:extension@5wed79aeavr.sip.livekit.cloud ``` (this is myCalls SIP server address) .
...
## Step 2: Import numbers to myCalls

You need to import to myCalls.
...
For PBX Extension:
   ...
   <Frame>
     <img
       src="/resources/zadarma-mycalls-type.png"
