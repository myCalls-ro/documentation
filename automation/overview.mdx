...
description: "Learn about myCalls.ro's built-in automation engine for creating workflows without coding"
---
...
myCalls.ro includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside myCalls.ro (e.g., "call ended," "inbound call context injection").
