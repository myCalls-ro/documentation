...
title: "myCalls Tool"
icon: "phone"
description: "Learn how to use myCalls triggers and actions in your AI calling flows"
---

# myCalls Tool

The myCalls tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the myCalls tool prominently displayed at the top of the
...
{/* ![myCalls Call Ended Trigger](/resources/mycalls-trigger.jpg) */}
...
{/* ![myCalls Action](/resources/mycalls-action.jpg) */}
