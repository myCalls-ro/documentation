...
The myCalls API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your myCalls account at [https://app.mycalls.ro](https://app.mycalls.ro)
...
```bash
curl -X GET "https://app.mycalls.ro/api/user/campaigns" \
