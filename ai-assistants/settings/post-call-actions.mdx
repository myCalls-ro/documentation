...
<AccordionGroup>
  ...
  <Accordion title="Webhook URL" icon="link">
    ...
    **Example:** `https://automate.mycalls.ro/api/v1/webhooks/your-webhook-id`
...
```json
{
  ...
  "transcript": [
    {
      "text": "Hello! This is Sarah from myCalls.",
      "type": "transcript",
      "sender": "bot",
  ...
  "formatted_transcript": "AI: Hello! This is Sarah from myCalls.\\nCustomer: Hi, I'm doing well, thanks.",
  "recording_url": "https://app.mycalls.ro/storage/recordings/call-12345.mp4",
